...
MSG: dict[str, str] = {
    ...
    'help': 'Если возникли проблемы с оплатой или вы не получили пресет,свяжитесь со мной по почте: lavkapresetshelp@gmail.com',
    'preset': 'Выбери подходящий вариант',
    'successful': 'Платёж на сумму {} р. прошел успешно, надеюсь, тебе понравиться😉'
}
